...
function _retry_n_reject (opts) {
    ...
    op_factory = opts.op_factory || function (operation) {return operation;},
...
function _api_call_promise(opts) {
    ...
    return new P(function (resolve, reject) {
        request(request_opts, function (err, response, body) {
            print_log(util.format("Requesting api Url: %s, Args: %s, Response: %s", request_opts.url, request_opts.body, body));
