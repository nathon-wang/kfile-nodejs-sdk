...
XFile.prototype.info = function (what) {
    ...
    if (isNaN(what)) {
        ...
        if (xid === this.xid || xid === undefined) {
            ...
            promise = this.delegate('XfileInfoV1', {xid: xid||_this.xid});
        }
    }
    return promise.then(function (detail) {
