...
libkkgen = ffi.Library('libkkgen', {
    'k_dec_keygen': ['int', ['char *', kstructPtr, 'char *']],
    'k_decrypt': ['int', ['char *', 'int', 'char *', 'int']],
});
...
KFileBlockCrypto.prototype._sdecrypt = function (skey, kinfo) {
    ...
    var kv = new kstruct({client_seeder: c_clientSeeder, timestamp: kinfo.clientTime, xid: kinfo.xid, domain_id: kinfo.domain_id, user_xid: kinfo.user_xid}),
    sbuf = new Buffer(32), k2;
    sbuf.fill(0);
    libkkgen.k_dec_keygen(c_skey, kv.ref(), sbuf);
    return sbuf.toString('utf-8');
};
