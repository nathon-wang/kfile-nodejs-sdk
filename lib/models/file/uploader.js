                            ...
                            .then(function (resp) {
                                ...
                                return _this.confirm_block(block_meta_info.i, block_meta_info.w, block_meta_info.s, block_upload_info.t)
                                    .then(function () {
                                        ...
                                        _this.logger.info(util.format('Uploading file %s, Total Size: %d, Upload Size: %s, Progress %s%%', _this.opts.path, _this.meta.file_size, confirmed_size, progress.toFixed(2)));
                                    });
                            })
