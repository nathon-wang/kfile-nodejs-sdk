                ...
                op_factory: function () {
                            ...
                            .then(function (resp) {
                                ...
                                return _this.confirm_block(block_meta_info.i, block_meta_info.w, block_meta_info.s, block_upload_info.t)
                                    .then(function () {
                                        confirm_bids.push(block_meta_info.i);
                                        _this.logger.info(util.format('Uploading file %s, Total Size: %d, Progress %s%%', _this.opts.path, _this.meta.file_size, (_this.meta.file_size/(confirm_bids.length*4*1024*1024))*100));
                                    });
                            })
