...
Downloader.prototype.download_block = function (bid, headers, stub) {
    ...
    .on('response', function (resp) {
        _this.delegation.logger.debug('Requesting download block from ks3 url: ' + url + ' Response code: ' + resp.statusCode);
    });
};
            ...
            return _this.diff_bundle(bids)
                .then(function (resp) {
                    ...
                    return P.mapSeries(blocks_in_bundle, function (block_info) { // download blocks in bundle
                        _this.delegation.logger.debug('Downloading block id %s......', block_info.i);
